...
def summarize_entry(entry: dict[str, Any], settings) -> dict[str, Any]:
    ...
    return {
        ...
        'vllm_available_kv_cache_memory_gb': startup_log.get('available_kv_cache_memory_gb'),
        ...
        'vllm_cuda_graph_pool_memory_actual_gb': startup_log.get('cuda_graph_pool_memory_actual_gb'),
        'vllm_cuda_graph_pool_memory_estimated_gb': startup_log.get('cuda_graph_pool_memory_estimated_gb'),
